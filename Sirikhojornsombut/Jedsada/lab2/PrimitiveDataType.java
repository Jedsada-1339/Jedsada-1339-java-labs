...
public class PrimitiveDataType {
    public static void main(String[] args) {
        String Id = "663040133-9";
        String Fist_name = "Jedsada";
        Byte byte_value = 39;
        Short Short_value = 339;
        int int_value = 401339;
        long long_value = 30401339;
        float float_value = 0.21f;
        Double double_value = 0.30401339;
        char char_value = 'J';
        Boolean boolean_value = true;
        System.out.println("Stduent Id : "+Id);
        System.out.println("Fist Name : "+Fist_name);
